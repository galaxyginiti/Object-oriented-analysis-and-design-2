...
import {
  ...
  NumberInput, TagsInput, Box, Alert, Code
} from '@mantine/core'
      ...
      <Stack gap="md">
        ...
        {result && (
          <Box mt="md">
            ...
            <Group mb="xs" gap="xs">
              <Text fw={600} size="sm">Итоговые навыки:</Text>
              {result.skills?.map(s => <Badge key={s} variant="light" color={templateColor[form.template] || 'blue'}>{s}</Badge>)}
            </Group>
